...
/* MY CUSTOM FUNCTIONS */
extern int
vbyte_join_compressed_sorted32(const uint8_t *inA, size_t lengthA, const uint8_t *inB, size_t lengthB);

extern int
vbyte_join_compressed_sorted32_symmetrical(const uint8_t *inA, size_t lengthA, const uint8_t *inB, size_t lengthB);

extern int
vbyte_join_compressed_sorted32_hybrid(const uint8_t *inA, size_t lengthA, const uint8_t *inB, size_t lengthB);

void vbyte_print_intervals(const uint8_t *in, size_t length);

// extern int
// vbyte_join_compressed_different_granularities(const uint8_t *inA, size_t lengthA, const uint8_t *inB, size_t lengthB, uint &powerA, uint &powerB);
